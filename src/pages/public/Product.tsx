...
export const Product: React.FC = () => {
  ...
  //=========================
  // Filter functionality (FIXED: Added null checks)
  //=========================

  const filteredProducts = useMemo(() => {
    return products.filter(product => {
      // 💡 Thêm Nullish Coalescing (?? '') để đảm bảo các thuộc tính là chuỗi
      const variantName = product.variant_name ?? '';
      const productSku = product.sku ?? '';
      const productColor = product.color ?? '';
      
      const matchesSearch = variantName.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  // FIX: Đảm bảo colors array không chứa giá trị null
  ...
  //=========================
  // Clear functionality (Giữ nguyên)
  //=========================
  ...
  //=========================
  // Checkout functionality (Giữ nguyên)
  //=========================
